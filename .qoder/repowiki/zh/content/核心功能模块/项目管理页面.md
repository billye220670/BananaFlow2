...
**图表来源**
- [app/projects/page.tsx:1-278](file://app/projects/page.tsx#L1-L278)
...
2. **项目列表展示** - 以网格形式展示用户项目，支持项目缩略图和元数据显示
3. **项目创建功能** - 提供一键创建新项目的能力
4. **项目导航** - 支持从项目列表直接进入画布编辑页面
...
**章节来源**
- [app/projects/page.tsx:25-278](file://app/projects/page.tsx#L25-L278)
...
**图表来源**
- [app/projects/page.tsx:69-107](file://app/projects/page.tsx#L69-L107)
...
项目列表采用响应式网格布局，支持不同屏幕尺寸的适配：

| 特性 | 实现方式 | 功能描述 |
|------|----------|----------|
| 响应式布局 | CSS Grid + Media Queries | 支持移动端到桌面端的自适应布局 |
| 项目缩略图 | Image 组件 + 占位符 | 动态加载项目缩略图或生成字母占位符 |
| 时间显示 | 相对时间格式化 | 显示项目最后更新时间（如"5分钟前"） |
| 加载状态 | Loader 组件 | 显示项目加载进度指示器 |

**章节来源**
- [app/projects/page.tsx:109-278](file://app/projects/page.tsx#L109-L278)
